...
import mysteryWordsImg from "../styles/img/mysterywords.png";
      ...
      <div id="work">
        ...
        <div className="container">
          ...
          <div className="row" >
              ...
              <div className="col-md-4" id="project-info">
                  <h5>Mystery Words</h5>
                  <p>Players guess letters until they are able to guess the correct word. If they miss 8 letters, they lose. The app utilizes Apple's dictionary and gives players and option of Easy, Medium or Hard words.</p>
